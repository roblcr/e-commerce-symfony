 ...
 */
final class Version20220316131740 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_derails CHANGE product product VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
